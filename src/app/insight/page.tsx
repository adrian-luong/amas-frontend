          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                traders để có cái nhìn tổng quan và đưa ra quyết định đầu tư
                thông minh.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    Tự động phát hiện và cảnh báo các Traders đang có momentum
                    tốt (📈).
                  </li>
                  <li>
                    Tự động cảnh báo Traders có dấu hiệu rủi ro (⚠️) (Drawdown
                    cao, hiệu suất giảm).
                  </li>
                  <li>
